...
import datakaryawan.controller.gaji.GajiController;
import datakaryawan.controller.karyawan.KaryawanController;
import datakaryawan.model.*;
import javax.swing.*;

public class ViewHitungGaji extends JFrame implements ActionListener {
GajiController Gaji = new GajiController();
KaryawanController Karyawan = new KaryawanController();
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (e.getSource() == buttonSubmit){
            Karyawan.edit(this, karyawan);
        }
        if (e.getSource() == buttonReset){
            Karyawan.delete(this, karyawan.getId());
        }
        ...
        if (e.getSource() == buttonGaji){
            Gaji.viewHasil(this, karyawan,total);
        }
    }
